...
describe('Service Tests', () => {
  describe('Mitarbeiter Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Mitarbeiter(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Mitarbeiter', async () => {
      ...
      it('should return a list of Mitarbeiter', async () => {
        const returnedFromService = Object.assign(
          {
            vorname: 'BBBBBB',
            nachname: 'BBBBBB'
